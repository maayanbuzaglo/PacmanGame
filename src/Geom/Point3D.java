...
public class Point3D implements Geom_element, Serializable {
	...
	/*
	 * Constructor that gets point 3d.
	 */
	...
	/*
	 * Constructor that gets point 2d.
	 */
	...
	/*
	 * return up/down if this point is above/under the SEGMENT (not the line).
	 */
	...
	/*
	 * returns the vertical angles in DEGREES of the vector this-->p.
	 */
	...
	/*
	 * transforms from radians to angles.
	 */
